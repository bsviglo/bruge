...
namespace render
{
...

	{
		...
		REGISTER_CONSOLE_METHOD("r_gapiType", _printGAPIType, Renderer);		
	}
	...
	//----------------------------------------------------------------------------------------------
	bool Renderer::init(ERenderAPIType apiType, HWND hWindow, const VideoMode& videoMode)
	{
		m_renderAPI = apiType;
	...
	//----------------------------------------------------------------------------------------------
	bool Renderer::beginPass(EPassType type)
	{
		m_pass = type;
	...
	//----------------------------------------------------------------------------------------------
	void Renderer::setCamera(const RenderCamera* cam)
	{
		assert(cam);
	...
	//----------------------------------------------------------------------------------------------
	void Renderer::addROPs(const RenderOps& ops)
	{
	...
	//----------------------------------------------------------------------------------------------
	void Renderer::addImmediateROPs(const RenderOps& ops)
	{
		RenderOps rOps = ops;
		_doDraw(rOps);
	}
	...
	//----------------------------------------------------------------------------------------------
	void Renderer::_doDraw(RenderOps& ops)
	{
	...
	//----------------------------------------------------------------------------------------------
	ShaderContext::EPassType Renderer::shaderPass(EPassType type) const
	{

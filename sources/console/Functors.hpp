...
namespace brUGE
{
	...
	public:
		virtual ~Functor() {}
		virtual void operator() (const ParamList& params) = 0;
	};
	...
	public:
		FunctorFunc(int (*f)())
			:	m_command(std::pair<ProcFunction, TypelessFunction>(proc_fn, reinterpret_cast<TypelessFunction>(f))) {}

		template <typename T1>
		FunctorFunc(int (*f)(T1))
			:	m_command(std::pair<ProcFunction, TypelessFunction>(proc_fn<T1>, reinterpret_cast<TypelessFunction>(f))) {}

		template <typename T1, typename T2>
		FunctorFunc(int (*f)(T1, T2))
			:	m_command(std::pair<ProcFunction, TypelessFunction>(proc_fn<T1,T2>, reinterpret_cast<TypelessFunction>(f))) {}

		template <typename T1, typename T2, typename T3>
		FunctorFunc(int (*f)(T1, T2, T3))
			:	m_command(std::pair<ProcFunction, TypelessFunction>(proc_fn<T1,T2,T3>, reinterpret_cast<TypelessFunction>(f))) {}

		template <typename T1, typename T2, typename T3, typename T4>
		FunctorFunc(int (*f)(T1, T2, T3, T4))
			:	m_command(std::pair<ProcFunction, TypelessFunction>(proc_fn<T1,T2,T3,T4>, reinterpret_cast<TypelessFunction>(f))) {}

		template <typename T1, typename T2, typename T3, typename T4, typename T5>
		FunctorFunc(int (*f)(T1, T2, T3, T4, T5))
			:	m_command(std::pair<ProcFunction, TypelessFunction>(proc_fn<T1,T2,T3,T4,T5>, reinterpret_cast<TypelessFunction>(f))) {}
		
		template <typename T1, typename T2, typename T3, typename T4, typename T5, typename T6>
		FunctorFunc(int (*f)(T1, T2, T3, T4, T5, T6))
			:	m_command(std::pair<ProcFunction, TypelessFunction>(proc_fn<T1,T2,T3,T4,T5,T6>, reinterpret_cast<TypelessFunction>(f))) {}
	...
	public:
		FunctorMethod(OBJ* obj, int (OBJ:: *m)())
			:	m_object(obj),
				m_command(std::pair<ProcMethod, TypelessMethod>(proc_md, reinterpret_cast<TypelessMethod>(m))) {}

		template <typename T1>
		FunctorMethod(OBJ* obj, int (OBJ:: *m)(T1))
			:	m_object(obj),
				m_command(std::pair<ProcMethod, TypelessMethod>(proc_md<T1>, reinterpret_cast<TypelessMethod>(m))) {}

		template <typename T1, typename T2>
		FunctorMethod(OBJ* obj, int (OBJ:: *m)(T1, T2))
			:	m_object(obj),
				m_command(std::pair<ProcMethod, TypelessMethod>(proc_md<T1,T2>, reinterpret_cast<TypelessMethod>(m))) {}

		template <typename T1, typename T2, typename T3>
		FunctorMethod(OBJ* obj, int (OBJ:: *m)(T1, T2, T3))
			:	m_object(obj),
				m_command(std::pair<ProcMethod, TypelessMethod>(proc_md<T1,T2,T3>, reinterpret_cast<TypelessMethod>(m))) {}

		template <typename T1, typename T2, typename T3, typename T4>
		FunctorMethod(OBJ* obj, int (OBJ:: *m)(T1, T2, T3, T4))
			:	m_object(obj),
				m_command(std::pair<ProcMethod, TypelessMethod>(proc_md<T1,T2,T3,T4>, reinterpret_cast<TypelessMethod>(m))) {}

		template <typename T1, typename T2, typename T3, typename T4, typename T5>
		FunctorMethod(OBJ* obj, int (OBJ:: *m)(T1, T2, T3, T4, T5))
			:	m_object(obj),
				m_command(std::pair<ProcMethod, TypelessMethod>(proc_md<T1,T2,T3,T4,T5>, reinterpret_cast<TypelessMethod>(m))) {}

		template <typename T1, typename T2, typename T3, typename T4, typename T5, typename T6>
		FunctorMethod(OBJ* obj, int (OBJ:: *m)(T1, T2, T3, T4, T5, T6))
			:	m_object(obj),
				m_command(std::pair<ProcMethod, TypelessMethod>(proc_md<T1,T2,T3,T4,T5,T6>, reinterpret_cast<TypelessMethod>(m))) {}

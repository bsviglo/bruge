...
const float	PI_2		  = 6.283185307179586476925287f;
const float RAD_to_DEG	  = 57.29577951308232087679815f;
const float DEG_to_RAD	  = 0.017453292519943295769237f;
const float E			  = 2.718281828458563411277850f;
const float INFINITY	  = 1e7f;
const float ONE_DIV_255   = 0.003921568627450980392156f;

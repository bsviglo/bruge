...
namespace math
{
	...
	public:
		...
		//-- Note: copy constructor and assign operator will be generated by compiler.
	...
	private:
		mat4f m_transform; //-- 64 bytes. ToDo: Try to minimize total memory amount.
	};
	...
	//-- Note: the dir vector is not normalized, its length is the max distance for a collision test.
	//----------------------------------------------------------------------------------------------

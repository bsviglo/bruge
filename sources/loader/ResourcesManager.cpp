...
{	
	...
	//------------------------------------------------------------------------------------------------------------------
	std::shared_ptr<render::IShader> ResourceSystem::World::loadShader(const char* name, const render::ShaderMacro* macros /* = NULL */, uint macrosCount /* = 0 */)
	{

	}

	//------------------------------------------------------------------------------------------------------------------
	std::shared_ptr<render::ITexture> ResourceSystem::World::loadTexture(const char* name)
	{

	}

	//------------------------------------------------------------------------------------------------------------------
	std::shared_ptr<render::Mesh> ResourceSystem::World::loadMesh(const char* name, bool simpleMaterial /* = false */)
	{

	}

	//------------------------------------------------------------------------------------------------------------------
	std::shared_ptr<render::SkinnedMesh> ResourceSystem::World::loadSkinnedMesh(const char* name)
	{

	}

	//------------------------------------------------------------------------------------------------------------------
	std::shared_ptr<Animation> ResourceSystem::World::loadAnimation(const char* name)
	{
